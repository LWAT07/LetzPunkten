...
public class NewSubjectFrame  extends JDialog{
    ...
    public NewSubjectFrame(NewClassData parent){
        ...
        nameField.addActionListener(e -> shortNameField.requestFocusInWindow());
        this.add(nameField);
        ...
        shortNameField.addActionListener(e -> coeffField.requestFocusInWindow());
        ...
        coeffField.addActionListener(e -> {
            saveValues(parent);
        });
        this.add(coeffField);
